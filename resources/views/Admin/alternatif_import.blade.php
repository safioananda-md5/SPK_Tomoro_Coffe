...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb border-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Import Alternatif</li>
        </ol>
    </nav>
    <div class="row mt-3">
        <div class="col-sm-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="fw-bold">Form Import Alternatif</h4>
                    ...
                    <hr>
                    <form action="{{ route('admin.alternatif.store_import') }}" method="POST" id="TambahAlternatif"
