                        ...
                        <div class="card d-none" id="real-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h4 style="fw-bold">Perhitungan Nilai Akhir</h4>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($criterias as $criteria)
                                                        <td class="text-center">
                                                            {{ $nilaiAkhir['criterias'][$criteria->id] }}</td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="card border-0 shadow-sm text-center py-5"
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                ...
                                <p class="text-muted small px-3 mb-0">
                                    Mohon tunggu sebentar, <span class="fw-semibold text-info">nilai akhir</span> sedang
