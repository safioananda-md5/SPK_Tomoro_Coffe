...
function sidebarType(e) {
    ...
    (("bg-transparent" != s && "bg-white" != s) || !a
        ...
        "bg-white" == s &&
            n &&
            (o = (l = document.querySelector(".navbar-brand-img"))
...
(0 != document.querySelectorAll(".input-group").length &&
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        [].slice
            .call(document.querySelectorAll(".toast-btn"))
            .map(function (t) {
                    ...
                    i.querySelector(
                        ...
                        if (i.classList.contains("flex-column")) {
                            ...
                            ((r.style.transform =
                                ...
                                (r.style.width =
                                    i.querySelector("li:nth-child(" + n + ")")
                                        .offsetWidth + "px"));
                        }
                    };
                }
...
(setTimeout(function () {
                ...
                : total.forEach(function (t, e) {
                      if (t.classList.contains("on-resize")) {
                          ...
                          ((r.style.transform =
                              "translate3d(" + e + "px, 0px, 0px)"),
                              (r.style.width =
                                  t.querySelector("li:nth-child(" + a + ")")
                                      .offsetWidth + "px"));
                      }
                  }));
    }),
    ...
    (window.onload = function () {
        ...
        for (
            var s = document.querySelectorAll(".btn"), t = 0;
            t < s.length;
            t++
        )
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (y = 0; y < s.length; y++)
            s[y].classList.contains("light") &&
                (s[y].classList.add("dark"), s[y].classList.remove("light"));
        for (y = 0; y < n.length; y++)
            n[y].classList.contains("light") &&
                (n[y].classList.add("dark"), n[y].classList.remove("light"));
        for (y = 0; y < a.length; y++)
            a[y].classList.contains("text-white") &&
                (a[y].classList.remove("text-white"),
                a[y].classList.add("text-dark"));
        for (y = 0; y < r.length; y++)
            !r[y].classList.contains("text-white") ||
                r[y].closest(".sidenav") ||
                r[y].closest(".card.bg-gradient-dark") ||
                (r[y].classList.remove("text-white"),
                r[y].classList.add("text-dark"));
        for (y = 0; y < o.length; y++)
            o[y].classList.contains("text-white") &&
                (o[y].classList.remove("text-white"),
                o[y].classList.add("text-dark"));
        for (y = 0; y < d.length; y++)
            d[y].classList.contains("text-white") &&
                !d[y].closest(".sidenav") &&
                (d[y].classList.remove("text-white"),
                d[y].classList.add("text-dark"));
        for (y = 0; y < u.length; y++)
            u[y].classList.contains("text-white") &&
                (u[y].classList.remove("text-white"),
                u[y].classList.remove("opacity-8"),
                u[y].classList.add("text-dark"));
        for (y = 0; y < v.length; y++)
            v[y].classList.contains("bg-gray-600") &&
                (v[y].classList.remove("bg-gray-600"),
                v[y].classList.add("bg-gray-100"));
        for (y = 0; y < L.length; y++)
            L[y].hasAttribute("fill") && L[y].setAttribute("fill", "#252f40");
        for (y = 0; y < m.length; y++)
            m[y].closest(".card.bg-gradient-dark") ||
                (m[y].classList.remove("text-white"),
        ...
        for (var y = 0; y < s.length; y++)
            s[y].classList.contains("dark") &&
                (s[y].classList.remove("dark"), s[y].classList.add("light"));
        for (var y = 0; y < n.length; y++)
            n[y].classList.contains("dark") &&
                (n[y].classList.remove("dark"), n[y].classList.add("light"));
        for (var y = 0; y < a.length; y++)
            a[y].classList.contains("text-dark") &&
                (a[y].classList.remove("text-dark"),
                a[y].classList.add("text-white"));
        for (var y = 0; y < i.length; y++)
            i[y].classList.contains("text-dark") &&
                (i[y].classList.remove("text-dark"),
                i[y].classList.add("text-white"));
        for (var y = 0; y < l.length; y++)
            l[y].classList.contains("text-dark") &&
                (l[y].classList.remove("text-dark"),
                l[y].classList.add("text-white"));
        for (var y = 0; y < c.length; y++)
            c[y].classList.contains("text-dark") &&
                (c[y].classList.remove("text-dark"),
                c[y].classList.add("text-white"));
        for (var y = 0; y < u.length; y++)
            u[y].classList.contains("text-secondary") &&
                (u[y].classList.remove("text-secondary"),
                u[y].classList.add("text-white"),
                u[y].classList.add("opacity-8"));
        for (var y = 0; y < f.length; y++)
            f[y].classList.contains("bg-gray-100") &&
                (f[y].classList.remove("bg-gray-100"),
